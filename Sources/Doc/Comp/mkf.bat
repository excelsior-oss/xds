...
rem   Cmponent - component to make: xc, xm
...
goto :lbl_make_%MAKE_COMPONENT%

rem ============================================= Make component
:lbl_make_xc
set MAKE_TASK=%MAKE_COMPONENT%  %TARGET_FMT%
echo \gencfalse  \gencodetrue  \geninteltrue   >..\Common\backend.tex
echo %~dp0
...
:lbl_make_xm
set MAKE_TASK=%MAKE_COMPONENT%  %TARGET_FMT%
echo \genctrue \gencodefalse  \gencodefalse  >..\Common\backend.tex
echo %~dp0
echo nmake /f %MAKE_COMPONENT%.mkf  TARGET_FMT=%TARGET_FMT%
call nmake /f %MAKE_COMPONENT%.mkf  TARGET_FMT=%TARGET_FMT% || goto lbl_Error
goto lbl_Success
