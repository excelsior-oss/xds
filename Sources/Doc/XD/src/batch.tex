...
The \TRef{{\tt \#IMPORT}}{batch:IMPORT} directive and the SIGNAL statement
...
The \verb'START/STOP' statements form a pair similar to \TRef{{\tt CALL/RETURN}}{batch:CALL},
...
The \verb'STOP' statement unwinds the \TRef{subroutine stack}{batch:CALL} up to the
